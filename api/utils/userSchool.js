...
function userSchool(auth,discordId,hunger,happiness,sleep,nextbill,schoolDays){
    if(auth === config.APIAuth){
        ...
        Users.findOneAndUpdate({discordId:discordId},{happiness:happiness,sleep:sleep,hunger:hunger,nextbill:nextbill,lastschool,schoolDays:schoolDays},{new:true},(err,data)=>{
